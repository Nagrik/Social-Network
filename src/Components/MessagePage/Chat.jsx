...
function Chat({ users, messages, userName, roomId, onAddMessage }) {
    ...
    const [openFieldMessage, setOpenFieldMessage] = useState(false);
    ...
    const openFieldOnActive = () => {
        setOpenFieldMessage(!openFieldMessage)
    }


    return (
        <div className="message__chat">
            <div className="message__chat-users">
                ...
                <div ref={messagesRef} className="messages">
                    {messages.map((message, i) => (
                        <div className="message" key={i}>
                            ...
                            {/*<p>{message.text}</p>*/}
                            <IncomingMessage message={message.text} name={message.userName}/>
                        </div>
                    ))}
                </div>

                <div className='WritePostField-message'>
                    {!openFieldMessage ?
	...
	C15.776,5,16,4.776,16,4.5v-1C16,3.225,15.776,3,15.5,3z">
                        ...
                        :
                        //@ts-ignore
                        <form onSubmit={onSendMessage} ref={areaRef}>
