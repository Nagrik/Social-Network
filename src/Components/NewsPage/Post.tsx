...
import author from "../../images/pinguin.png";
    ...
    return (
                ...
                <div className="Posts__author">
                    <div className="Posts__author-name">
                        <div className="Posts__author-photo">
                            <img src={author} alt=''/>
                            {
                                !news.author ? <span>Anonymous</span> : <span>{news.author}</span>
                            }
                        </div>
                    ...
                    <div className="Posts__arrow">
                        <div className="InputIcon">
                            <svg fill="currentColor" height="18" width="18" viewBox="0 0 64 64">
                                <g>
		...
		49,24 	" fill="none" stroke="currentColor">
                ...
                <div className="Posts__text-wrapper">
                    <h3>{news.title}</h3>
                    <hr/>
                    <div className='Post__text-photo'>
                        {
                            news.urlToImage ? <img src={news.urlToImage} alt={news.url}/> : ''
                        }
                    </div>
                    <p>{news.content}</p>
                </div>
